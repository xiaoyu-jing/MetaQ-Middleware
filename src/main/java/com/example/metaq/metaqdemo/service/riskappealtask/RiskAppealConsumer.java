 ...
 * @describe
 */
public class RiskAppealConsumer {
    ...
    public static void main(String[] args) throws MQClientException {
         ...
         */
        MetaPushConsumer consumer = new MetaPushConsumer("CID_risk_appeal_bops_consumer");
         ...
         */
        consumer.subscribe("AE_GLOBAL_RISK_APPEAL_TOPIC", "*");
